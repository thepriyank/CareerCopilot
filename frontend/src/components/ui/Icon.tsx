...
export const Icon = {
  ...
  EyeOff:     ic(<><path d="M3 3l18 18"/><path d="M10.6 5.1A10.8 10.8 0 0112 5c6 0 10 7 10 7a17.7 17.7 0 01-3.2 4M6.6 6.6C4 8.3 2 12 2 12s4 7 10 7a9.7 9.7 0 004.6-1.1"/><path d="M9.9 9.9a3 3 0 004.2 4.2"/></>),
