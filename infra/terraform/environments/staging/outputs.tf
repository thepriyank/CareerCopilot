...
output "provisioned_secret_ids" {
  description = "Secret Manager secret ids created for this environment — populate each with its real value before the backend service can actually use it (see README.md)."
